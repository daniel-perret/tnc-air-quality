...
### Inputs:
### stand -- the unique stand ID
### managementID -- identifier for management scenario
### params_row -- not used in function? removed this input ***
### outputDatabase -- .db for all outputs
### treat_kcp -- optional .kcp specifying treatment
### fire_kcp -- optional .kcp specifying fire
### inputDabase -- .db with all input tables


createKeyText_withExtraStandDat_rx <- function(stand,            # Unique stand ID present in the standinit data
                                            managementID,     # identifier for management scenario
  ...
  keytext <- paste0(
    ...
    # 'SNAGOUT\n',
    # 'SNAGSUM\n',
    'FIRECALC           0         1        2\n',  # last arg is 2=53 FBFM, 2=40; which matches Flamstat better?
    'STATFUEL\n',
    'END\n',
