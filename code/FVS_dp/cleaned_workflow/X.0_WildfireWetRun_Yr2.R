#### X.0_WildfireWetRun_Yr2.R
#### Runs FVS wildfire simulations across six flame length bins for all CONUS variants.
#### The key difference here between 1.0 and this script is that we're burning the stands in year 3, to assess how large a difference the couple years of growth/decay make.
